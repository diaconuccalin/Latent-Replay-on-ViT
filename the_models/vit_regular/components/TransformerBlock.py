...
from the_models.vit_regular.components.MultiHeadSelfAttentionWithProjectionAndDropout import (
    MultiHeadSelfAttentionWithProjectionAndDropout,
)
from the_models.vit_regular.components.PositionWiseFeedForwardWithDropout import (
